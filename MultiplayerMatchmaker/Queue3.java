...
public class Queue3 extends ViewableAtomic {
	...
	public Queue3(int queueCapacity, ArrayDeque<Player> Q1, ArrayDeque<Player> Q2, ArrayDeque<Player> Q3) {
		this("Q3", queueCapacity, Q1, Q2, Q3);
	}

	public Queue3(String name, int queueCapacity, ArrayDeque<Player> Q1, ArrayDeque<Player> Q2, ArrayDeque<Player> Q3) {
		super(name);
...
//		}
		...
		return algo(new ArrayList<Player>(Q3));
	}
