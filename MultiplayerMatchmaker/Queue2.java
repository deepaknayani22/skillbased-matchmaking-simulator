...
public class Queue2 extends ViewableAtomic {
	...
	public Queue2(int queueCapacity, ArrayDeque<Player> Q1, ArrayDeque<Player> Q2, ArrayDeque<Player> Q3) {
		this("Q2", queueCapacity, Q1, Q2, Q3);
	}

	public Queue2(String name, int queueCapacity, ArrayDeque<Player> Q1, ArrayDeque<Player> Q2, ArrayDeque<Player> Q3) {
		super(name);
...
//		}
		...
		return algo(new ArrayList<Player>(Q2));
	}
